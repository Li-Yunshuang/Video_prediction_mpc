...
'sequence_length': 30,      # 30'sequence length to load, including context frames.' ,
...
'sawyer':'',
'single_view':"",
'use_len':15               # 14 number of steps used for training where the starting location is selected randomly within sequencelength
#'1stimg_bckgd':''
}