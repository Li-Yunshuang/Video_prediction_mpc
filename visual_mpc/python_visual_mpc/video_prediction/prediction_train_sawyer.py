...
class Model(object):
    def __init__(self,
        ...
        if 'use_len' in conf:
            ...
            # Not into this line
            images, states, actions  = self.random_shift(images, states, actions)  # shiftingg the video sequence
    ...
    def random_shift(self, images, states, actions):
        ...
        tshift = 2
        uselen = self.conf['use_len']   #15
        fulllength = self.conf['sequence_length']    # 30
        nshifts = (fulllength - uselen) / 2 + 1    # (30-15) / 2 + 1
